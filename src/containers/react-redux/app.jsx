...
import Counter from '@/components/react-redux/counter.jsx'
//容器组件
...
export default connect(
    ...
    { increment: increment, decrement: decrement }//是一个对象，前面属性名，后面属性值。作为UI组件Counter组件的属性。即mapDispatchToProps
)(Counter)
//包装UI组件Counter